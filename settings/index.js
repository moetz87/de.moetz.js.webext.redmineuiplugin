...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__url__ = __webpack_require__(11);
...
class Main {
    ...
    static main() {
        let rules = new __WEBPACK_IMPORTED_MODULE_0__rules__["Rules"]('#rulesanchor');
        rules.load().then(() => rules.render());
        __WEBPACK_IMPORTED_MODULE_2_jquery__('#button-addrule').on('click', () => rules.add(__WEBPACK_IMPORTED_MODULE_0__rules__["Rule"].createDefault()));
        __WEBPACK_IMPORTED_MODULE_2_jquery__('#button-saverules').on('click', () => rules.save());

        let url = new __WEBPACK_IMPORTED_MODULE_1__url__["URL"]('#urlanchor');
        url.load().then(() => url.render());
        __WEBPACK_IMPORTED_MODULE_2_jquery__('#button-savesettings').on('click', () => url.save());
    }
