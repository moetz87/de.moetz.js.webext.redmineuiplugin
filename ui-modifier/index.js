...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__settings_rules__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__settings_rules___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__settings_rules__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__settings_url__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__settings_url___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__settings_url__);
...
class Main {
    ...
    static main() {
        let url = new __WEBPACK_IMPORTED_MODULE_1__settings_url__["URL"]();
        url.load().then(() => {
            let regex = new RegExp(url.urlPattern, 'g');
            let currentUrl = window.location.href;
            if (regex.test(currentUrl)) {
                console.log('matches');
                let rules = new __WEBPACK_IMPORTED_MODULE_0__settings_rules__["Rules"]();
                rules.load().then(() => rules.rules.forEach(rule => __WEBPACK_IMPORTED_MODULE_2_jquery__(rule.selector).css(JSON.parse(rule.css))));
            } else {
